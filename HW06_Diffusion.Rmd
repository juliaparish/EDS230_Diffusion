...
```{r}
# ggsave(file = "resultA_plot1.png", plot = resultA_plot1,
#   scale = 1, width = 6, height = 6,
#   units = "in", dpi = 300)
```

```{r, eval=FALSE}
# ggsave(file = "resultA_plot2.png", plot = resultA_plot2,
#   scale = 1, width = 6, height = 6,
#   units = "in", dpi = 300)
```

```{r, eval=FALSE}
# ggsave(file = "resultB_plot1.png", plot = resultB_plot1,
#   scale = 1, width = 6, height = 6,
#   units = "in", dpi = 300)
```

```{r, eval=FALSE}
# ggsave(file = "resultB_plot2.png", plot = resultB_plot2,
#   scale = 1, width = 6, height = 6,
#   units = "in", dpi = 300)
```
